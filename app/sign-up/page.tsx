      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-4 sm:px-6">
        ...
        >
          ...
          <div className="mb-4 text-center sm:mb-5">
            ...
            <p className="mx-auto mt-1.5 max-w-sm text-xs leading-5 text-slate-400 sm:text-sm">
              Join CardForge and start creating beautiful professional ID
              cards.
            </p>
          </div>
          ...
          <p className="mt-3 text-center text-[10px] text-slate-600 sm:text-xs">
            Create your account and start building with CardForge.
          </p>
        </motion.div>
      </div>
    </main>
